...
class Match extends Component {
	...
	componentDidMount() {
		subscribers.push(this.update.bind(this));
	}
	componentWillUnmount() {
		subscribers.splice(subscribers.indexOf(this.update.bind(this))>>>0, 1);
	}
	render(props) {
...
export { subscribers, getCurrentUrl, route, Router, Route, Link, Match };
